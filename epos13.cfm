...
<head>
	...
	<title>EPOS-13</title>
	<style type="text/css">
		#tillpanel {width:550px; float:left; margin:10px; padding:10px; border:solid 2px #ccc; background:#eee; font-family:Arial, Helvetica, sans-serif; font-size:14px;}
	...
	<cffunction name="LoadProducts" access="public" returntype="query">
		...
		<cftry> 
			<cfquery name="loc.QProducts" datasource="#args.datasource#" result="loc.QProductsResult">
				...
				INNER JOIN tblEPOSCats ON prodEposCatID=epcID
				WHERE prodSuppID =0
				AND prodEposCatID IN (42,142,152,161,171,181,191) )	
			</cfquery>
...
<cfobject component="code/epos13" name="ecfc">
